...
<body>
    <div class="container-fluid">
        ...
        <form action="/smartnotes/index.php/login" method="POST" id="login-form">
        ...
        <p class="login-wrapper-footer-text">Need an account? <a href="#" id="signup-toggle" style="color: #171a59;"> Signup here</a></p>
                ...
                <div class="sign-up-form" style="display: none;">
                    ...
                    <form action="/smartnotes/index.php/register" method="POST" id="form"> <!-- Ensure the form submits to login.php -->
                        <div class="form-group">
