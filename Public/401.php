         ...
         <div class="row no-gutters height-self-center">
            <div class="col-sm-12 text-center align-self-center">
               <div class="iq-error position-relative">
                     ...
                     <a class="btn btn-primary d-inline-flex align-items-center mt-3" href="<?php echo "/smartnotes/app/Views/".$UserObject->userType_obj->pages_array[0]->link_address; ?>"><i class="ri-home-4-line"><i class="ri-home-4-line"></i>Back to Home</a>
